/******/ (() => {
  ...
  \*********************************************/
			/***/ (module) => {
				module.exports = /*#__PURE__*/ JSON.parse(
					'{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/dynamic-block","version":"0.1.0","title":"Dynamic Block","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"textdomain":"wp-multi-block","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}'
				);
  ...
  \******************************************/
			/***/ (
				...
				/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ./editor.scss */ './src/blocks/dynamic-block/editor.scss'
					);
				...
				function Edit() {
					...
					react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)('p', {
						...
						_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)(
							'Dynamic Block – hello from the editor!',
							'dynamic-block'
						),
					});
				}
		...
		/***/ './src/blocks/dynamic-block/editor.scss':
			/*!**********************************************!*\
  !*** ./src/blocks/dynamic-block/editor.scss ***!
  \**********************************************/
			/***/ (
  ...
  \*******************************************/
			/***/ (
				...
				/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./style.scss */ './src/blocks/dynamic-block/style.scss'
					);
				/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ./edit */ './src/blocks/dynamic-block/edit.js'
					);
				/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(
						/*! ./block.json */ './src/blocks/dynamic-block/block.json'
					);
  ...
  \**********************************/
	...
	/******/ (() => {
		...
		/******/ var installedChunks = {
			/******/ 'blocks/dynamic-block/index': 0,
			/******/ 'blocks/dynamic-block/style-index': 0,
			/******/
		};
		/******/
	...
	/******/ var __webpack_exports__ = __webpack_require__.O(
		undefined,
		['blocks/dynamic-block/style-index'],
		() => __webpack_require__('./src/blocks/dynamic-block/index.js')
	);
